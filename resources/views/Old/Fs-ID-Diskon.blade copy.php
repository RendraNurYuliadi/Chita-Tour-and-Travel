    ...
    <header>
        ...
        <a href="#" class="logo"> <i class='bx bxs-home' ></i>Fashion-Hub</a>
         ...
         <ul class="navlist">
             ...
             <li><a href="#shop" class="active">Semua Produk</a></li>
             <li><a href="{{ route('products.KategoriData') }}">Kategori</a></li>
             <li><a href="#contact">Kontak Kami</a></li>
         </ul>
 
         <div class="nav-icons">
            <a href="{{ route('products.KategoriData') }}"><i class='bx bx-search-alt' ></i></a>
            <a href="{{ route('products.showAllData') }}"><i class='bx bx-cart-alt' ></i></a>
