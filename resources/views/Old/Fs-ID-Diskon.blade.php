    ...
    <header>
        ...
        <a href="#" class="logo"> <i class='bx bxs-home' ></i>Fashion-Hub</a>
         ...
         <ul class="navlist">
             ...
             <li><a href="{{ route('products.diskon') }}"  class="active">Diskon</a></li>
     ...
     <section class="home" id="home">
         <div class="home-text">
            <h1>Nikmati <span>Produk </span><br>Diskon, <span>FashionHub </span> <br>Gaya di Ujung Jari!</h1>
         ...
         <div class="home-img">
             <img src="{{ asset('/Latihan-002/public/img/disc3.png')}}" alt="">
         </div>
...
{{-- 
    ...
    @csrf
            ...
            <!-- <h5 required name="tipe_makanan">{{ $row->tipe_makanan }} </h5> -->
                ...
                <div class="in-text">
                    <div class="price">
                      <h6 required name="harga" style=" color:black; font-size:15px; ">Harga Awal : Rp.{{ number_format($row->harga, 0, ',', '.') }}</h6>
                      <h6 required name="harga" style=" color:black; font-size:15px; ">Diskon : {{ number_format($row->diskon, 0, ',', '.') }}%</h6>
                      <h6 required name="harga">Harga Diskon : Rp.{{ number_format($row->harga2, 0, ',', '.') }}</h6>
