...
<body>
    ...
    <header>
        ...
        <a href="#" class="logo"> <i class='bx bxs-home' ></i>Fashion-Hub</a>
         ...
         <ul class="navlist">
             <li><a href="{{ route('products.showData') }}" class="active">Home</a></li>
            ...
            <li><a href="{{ route('products.diskon') }}">Diskon</a></li>
             ...
             <li><a href="#review">Keunggulan</a></li>
     ...
     <section class="home" id="home">
         <div class="home-text">
             <h1>Kenyamanan, <span>Kebutuhan & </span> <br> Tampilan,  <span>FashionHub </span> <br>Gaya di Ujung Jari!</h1>
         ...
         <div class="home-img">
             <img src="{{ asset('/Latihan-002/public/img/mob1.png')}}" alt="">
         </div>
    ...
    <section class="about" id="about">
        <div class="about-img">
            <img src="{{ asset('/Latihan-002/public/img/lobi.png')}}" alt="">
        </div>
        ...
        <div class="about-text">
            ...
            <a href="https://www.jakartafashionhub.com/" class="btn">Cari Tau?<i class='bx bxs-right-arrow' ></i></a>
    ...
    @csrf
            ...
            <!-- <h5 required name="tipe_makanan">{{ $row->tipe_makanan }} </h5> -->
                ...
                <div class="in-text">
                    ...
                    <div class="s-btn">
           <a href="/produk/nama/{{ $row->nama }}">Detail Produk</a>
        ...
        <div class="row-btn">
            <a href="{{ route('products.showAllData') }}" class="btn">Lihat Semua Produk<i class='bx bxs-right-arrow' ></i></a>
        </div>
    ...
    <section class="review " id="review">
        <div class="middle-text">
            <h4>Keunggulan Toko Kami</h4>
            <h2>Keunggulan & Kelebihan Toko Fashion-Hub</h2>
        </div>
    
        <div class="review-content">

            <div class="box">
                <p>Fashion Hub menawarkan berbagai produk fashion dari merek-merek terkemuka, mulai dari pakaian, sepatu, aksesori, hingga tas, sehingga pelanggan memiliki banyak pilihan untuk memenuhi gaya dan kebutuhan mereka.</p>
                <div class="in-box">
                    <div class="bx-img">
                        <img src="{{ asset('/Latihan-002/public/img/lengkap.png')}}" alt="" >
                    </div>
                        <div class=" bxx-text">
                            <h4>Koleksi Yang Beragam!</h4>
                            <h5>Produk Yang Lengkap</h5>
                            <div class="ratings">
              ...
              <div class="box">
                <p>Fashion Hub hanya menyediakan produk berkualitas tinggi. Setiap item melewati proses seleksi ketat, sehingga pelanggan dapat mempercayai keandalan produk yang mereka beli. Jadi kamu jangan ragu untuk belanja di toko kami ya!</p>
                <div class="in-box">
                    <div class="bx-img">
                        <img src="{{ asset('/Latihan-002/public/img/kualitas.png')}}" alt="">
                    </div>
                        <div class=" bxx-text">
                            <h4>Kualitas Produk yang Tinggi!</h4>
                            <h5>Aman & Berkualitas</h5>
                            <div class="ratings">
                                <a href="#"><i class='bx bxs-star'></i></a>
                                <a href="#"><i class='bx bxs-star'></i></a>
                                <a href="#"><i class='bx bxs-star'></i></a>
              ...
              <div class="box">
                <p>Toko ini mengutamakan kepuasan pelanggan dengan staf yang ramah dan siap membantu pelanggan dengan pertanyaan, permintaan khusus, atau masalah apa pun yang mungkin timbul selama proses pembelian.</p>
                <div class="in-box">
                    <div class="bx-img">
                        <img src="{{ asset('/Latihan-002/public/img/ramah.png')}}" alt="">
                    </div>
                        <div class=" bxx-text">
                            <h4>Ramah & Profesional!</h4>
                            <h5>Pelayan Friendly</h5>
                            <div class="ratings">
                                <a href="#"><i class='bx bxs-star'></i></a>
                                <a href="#"><i class='bx bxs-star'></i></a>
                                <a href="#"><i class='bx bxs-star'></i></a>
...
<section class="contact" id="contact">
    <div class="contact-content">
        ...
        <div class="details">
            ...
            <div class="main-d">
                <a href="#"><i class='bx bxl-youtube' ></i>FS-HUB</a>
            </div>
            <div class="main-d">
