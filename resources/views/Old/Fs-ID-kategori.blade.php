...
<body>
    ...
    <header>
        ...
        <a href="#" class="logo"> <i class='bx bxs-home' ></i>Fashion-Hub</a>
         ...
         <ul class="navlist">
             ...
             <li><a href="{{ route('products.showAllData') }}" >Semua Produk</a></li>
         	  <li><a href="{{ route('products.diskon') }}">Diskon</a></li>
             <li><a href="{{ route('products.KategoriData') }}" class="active">Kategori</a></li>
     ...
     <section class="home" id="home">
         <div class="home-text">
            <h1>Temukan <span>Produk </span> <br> Impianmu,  <span>FashionHub </span> <br>Gaya di Ujung Jari!</h1>
         ...
         <div class="home-img">
             <img src="{{ asset('/Latihan-002/public/img/cag.png')}}" alt="">
         </div>
    ...
    <section class="shop" id="shop">
        <div class="middle-text">
            <h4>Tipe Produk</h4>
            <h2>List Produk Baju</h2>
        </div>
        <div class="shop-content">
        @foreach ($TampilBaju as $row )
...
<section class="shop" id="shop">
    <div class="middle-text">
        <h4>Tipe Produk</h4>
        <h2>List Produk Celana</h2>
    </div>
    <div class="shop-content">
    @foreach ($TampilCelana as $row )
...
<section class="shop" id="shop">
    <div class="middle-text">
        <h4>Tipe Produk</h4>
        <h2>List Produk Kosmetik </h2>
    </div>
    <div class="shop-content">
    @foreach ($TampilKosmetik as $row )
...
<section class="shop" id="shop">
    <div class="middle-text">
        <h4>Tipe Produk</h4>
        <h2>List Produk Aksesoris</h2>
    </div>
    <div class="shop-content">
    @foreach ($TampilAksesoris as $row )
...
<section class="shop" id="shop">
    <div class="middle-text">
        <h4>Tipe Produk</h4>
        <h2>List Produk Tas</h2>
    </div>
    <div class="shop-content">
    @foreach ($TampilTas as $row )
